...
public class PaxosProp {
    ...
    private int masterElectMinInterval = SystemPropertyUtil.getInt("klein.consensus.paxos.master.elect-min-interval", masterHeartbeatInterval * SystemPropertyUtil.getInt("klein.id", 1));
